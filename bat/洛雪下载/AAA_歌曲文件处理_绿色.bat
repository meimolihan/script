...
echo * 0. 【退出】
echo ==============================
set /p choice="请输入操作编号 (0 - 9/x): "

	
	if "%choice%"=="1" call :music_aaa && goto music_menu
	if "%choice%"=="2" call :music_bbb && goto music_menu
	if "%choice%"=="3" call :music_ccc && goto music_menu
	if "%choice%"=="4" call :music_ddd && music_menu
	if "%choice%"=="5" call :music_eee && goto music_menu
	if "%choice%"=="6" call :music_fff && goto music_menu
	if "%choice%"=="7" call :music_ggg && goto music_menu
	if "%choice%"=="8" call :music_hhh && goto music_menu
	if "%choice%"=="9" call :music_iii && goto music_menu
	if "%choice%"=="x" call :music_jjj && goto music_menu
