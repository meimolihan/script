...
clear
print_separator
echo -e "\033[1;35m            欢迎来到 BBR 管理脚本      \033[0m"
print_separator
echo -e "\033[36m当前拥塞控制算法：\033[0m\033[1;32m$CURRENT_ALGO\033[0m"
...
case "$ACTION" in
    1)
        echo -e "\033[1;32m您选择了安装或更新 BBR v3！\033[0m"
        install_latest_version
        ;;
    2)
        echo -e "\033[1;32m您选择了安装指定版本的 BBR！\033[0m"
        install_specific_version
        ;;
    3)
    ...
    6)
        ...
        ;;
    7)
        echo -e "\033[1;32m您选择了卸载 BBR 内核！\033[0m"
