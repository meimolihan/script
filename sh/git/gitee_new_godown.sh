...
echo -e "${BLUE}==================================${RESET}"
echo -e "${BLUE}Gitee 新仓库初始化脚本${RESET}"
echo -e "${BLUE}==================================${RESET}"
echo -e "${YELLOW}注意事项："
echo -e "1. 请确保已在 Gitee 创建同名空仓库"
echo -e "2. 请确保已在 Gitee 创建名为 ${repo_dir} 仓库"
echo -e "3. 需要提前配置好 SSH 密钥${RESET}"
echo -e "${BLUE}==================================${RESET}"
echo -e "当前操作目录: $(pwd)"
echo -e "${BLUE}==================================${RESET}"
...
# 提交更改
if ! git commit -m "feat: 初始提交"; then
...
# 推送代码
echo -e "${BLUE}正在推送代码到 Gitee...${RESET}"
...
echo -e "${GREEN}仓库地址：https://gitee.com/meimolihan/${repo_name}${RESET}"
echo -e "${GREEN}==================================${RESET}"
# 获取当前远程仓库信息
