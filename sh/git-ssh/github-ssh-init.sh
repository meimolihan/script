...
cat <<'BANNER'
  ...
  Welcome to GitHub SSH Auto-Init Script  |  Author: You
  本脚本将带你零配置完成 GitHub SSH 密钥设置，只需按提示操作即可！
  官方添加页面：https://github.com/settings/keys
>>>>>>>>>>>>>>>> 脚本开始 <<<<<<<<<<<<<<<<
BANNER
...
step_show_pub_and_wait() {
    ...
    cat "${KEY_FILE}.pub"
    echo "=================================================="
    echo -e "${BLUE}打开 GitHub 官方添加页面：${NC} https://github.com/settings/keys"
    echo
