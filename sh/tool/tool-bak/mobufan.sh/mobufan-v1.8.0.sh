...
handle_invalid_input() {
    # echo -ne "\r${gl_hong}无效的输入,请重新输入! ${gl_zi} 2 ${gl_hong} 秒后返回${gl_bai}"
    # sleep 1
...
discourse,yunsou,ahhhhfs,nsgame,gying" \
        ...
        117 | random)
            ...
            local docker_url="官网介绍: ${gh_proxy}github.com/meimolihan/random-pic-api"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
        ...
        118 | hd-Icons)
            ...
            local docker_url="官网介绍: ${gh_proxy}github.com/xushier/HD-Icons"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
