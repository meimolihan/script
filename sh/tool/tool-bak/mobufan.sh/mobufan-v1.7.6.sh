...
discourse,yunsou,ahhhhfs,nsgame,gying" \
        ...
        109 | md)
            ...
            local docker_url="官网介绍: ${gh_proxy}gitee.com/streamerzero/md"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
        ...
        110 | xiaomusic)
            ...
            local docker_img="m.daocloud.io/docker.io/hanxi/xiaomusic"
            local docker_port=8090
            ...
            local docker_url="官网介绍: ${gh_proxy}xdocs.hanxi.cc"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
        ...
        111 | taosync)
            ...
            local docker_url="官网介绍: ${gh_proxy}github.com/dr34m-cn/taosync"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
        ...
        112 | musicn)
            ...
            local docker_url="官网介绍: ${gh_proxy}github.com/wy580477/musicn-container"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
        ...
        113 | aipan)
            ...
            local docker_url="官网介绍: ${gh_proxy}github.com/unilei/aipan-netdisk-search"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
        ...
        114 | vert)
            ...
            local docker_url="官网介绍: ${gh_proxy}github.com/VERT-sh/VERT"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
        ...
        115 | easynode)
            ...
            local docker_url="官网介绍: ${gh_proxy}github.com/chaos-zhu/easynode"
            local docker_use="sleep 3"
        ...
        116 | mind-map)
            ...
            local docker_url="官网介绍: ${gh_proxy}github.com/wanglin2/mind-map"
            local docker_use=""
            local docker_passwd=""
            local app_size="1"
            docker_app
