    ...
    while true; do
        ...
        *) boot_zh="${gl_hui}未知" ;;
        ...
        1)
            ...
            f2b_install_sshd
            cd /etc/fail2ban
            wget https://gitee.com/meimolihan/fail2ban/raw/master/jail.local
...
linux_nginx_menu() {
    while true; do
        ...
        echo -e "${gl_bufan}3.  ${gl_bai}测试Nginx配置          ${gl_bufan}4.  ${gl_bai}测试Nginx并重启"
        echo -e "${gl_bufan}------------------------------------------------${gl_bai}"
        echo -e "${gl_bufan}5.  ${gl_bai}查看80端口占用         ${gl_bufan}6.  ${gl_bai}查看Nginx运行状态"
